 ...
 * [InternalMutatorMutex] instance should be hidden as an implementation detail.
 *
 */
@Stable
internal class InternalMutatorMutex {
     ...
     *
     * If [mutate] is called while another call to [mutate] is in progress, their
     ...
     * needs to be cancelled through a [mutate] call with an equal or higher
     * mutation priority.
     *
     * Calls to [mutate] will suspend until execution of the [block] has finished.
     *
     * @param block mutation code to run mutually exclusive with any other call to [mutate] or
     * [tryMutate].
