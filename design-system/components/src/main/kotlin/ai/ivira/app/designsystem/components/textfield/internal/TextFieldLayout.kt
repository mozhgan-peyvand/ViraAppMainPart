...
package ai.ivira.app.designsystem.components.textfield.internal

import ai.ivira.app.designsystem.components.textfield.ViraOutlinedTextFieldDefaults.DefaultErrorMessage
...
fun TextField(
    ...
    BasicTextField(
        ...
        modifier = modifier
            ...
            .defaultErrorSemantics(isError, DefaultErrorMessage)
            .defaultMinSize(
