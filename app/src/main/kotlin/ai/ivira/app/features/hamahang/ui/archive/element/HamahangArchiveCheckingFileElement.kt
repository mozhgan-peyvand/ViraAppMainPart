...
@Composable
fun HamahangArchiveCheckingFileElement(
    value: HamahangCheckingFileView,
    isNetworkAvailable: Boolean,
    isErrorState: Boolean,
    onTryAgainClick: (HamahangCheckingFileView) -> Unit,
    onMenuClick: (HamahangCheckingFileView) -> Unit
) {
    Row(
        ...
        IconButton(
            ...
            onClick = {
                safeClick {
                    if (isErrorState) onTryAgainClick(value)
                }
            }
        ) {
            HamahangIconItemState(
                ...
                isEnabled = isNetworkAvailable && value.isProper
            )
        }
        ...
        Column(
            ...
            if (!value.isProper) {
                Text(
                    text = stringResource(id = R.string.msg_audio_contains_inappropriate_contents),
...
@ViraDarkPreview
@Composable
private fun HamahangArchiveCheckingFileElementPreview() {
    ViraPreview {
