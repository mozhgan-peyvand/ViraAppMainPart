package ai.ivira.app.features.hamahang
...
@Singleton
class HamahangTracker @Inject constructor(private val hamahangRepository: HamahangRepository) {
    companion object {
    ...
    init {
        coroutineScope.launch(Dispatchers.IO) {
            hamahangRepository.getTrackingFiles()
    ...
    private suspend fun trackFile(tracking: HamahangTrackingFileEntity) {
    ...
    private suspend fun trackFileFallbackMode(
        ...
        while (true) {
            ...
            val isSuccess = hamahangRepository.trackVoiceConversion(tracking.token) is AppResult.Success
            if (isSuccess) {
                mutex.withLock {
    ...
    private suspend fun trackFileWithEstimation(job: Job, tracking: HamahangTrackingFileEntity) {
